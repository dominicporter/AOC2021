...
import Day4TestData exposing (actualCalledNumbers, actualBingoCards)
        ...
        describe "Day4" <|
            ...
            , describe "getBingoFinalScore"
                ...
                , test "works with actual Input" <|
                    \_ ->
                        Expect.equal (getBingoFinalScore actualCalledNumbers actualBingoCards) 4512
                ]
            ]
